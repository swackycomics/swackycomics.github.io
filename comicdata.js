...
var comicjson = {
    "redbidd": {
		...
		"comic9": {
            ...
            "series": "The RedBidd Comics",
            "title": "MAD BILL",
            "pages": (comicpages[0][1][ 8 ]).toString(),
            "desc": "Would you look at that... THE BILL IS BACK! And just when RedBidd and the pals thought they could get away with some sun grabbing on a tuesday sewer morning... A DEAL'S A DEAL! Will THE REDBIDD PROTAGONISTS make their way out of those smelly sewers? Will MISTERIO and his new friends get to OUR HEROES? Find out in today's episode of THE. REDBIDD. COMICS.",
	...
	"swackzards": {
		...
		"comic2": {
            ...
            "series": "SWACKZARDS!",
            "title": "TAXPAYERS",
            "pages": (comicpages[4][1][ 1 ]).toString(),
            "desc": "Styx and Crius were having a fantastic time doing absolutely nothing in their apartment all day. When SUDDENLY..! It has come to their attention that they're, apparently, hundreds of dollars in tax debt. BIG WHOOPSIES! You wouldn't want to be in their shoes, that's for sure. So these two nutheads set out to an ANTI TAX EVADING ADVENTURE! If only they knew what they were getting into.",
...
var data = {
    "comic1": {
		...
		"minidesc": "The most deranged comic series you're ever going to read.",
		"href": "/comics/the_redbidd_comics/",
		"discontinued": false,
	},
	"comic2": {
        "thumb": "series/swackzards_comics_thumb.png",
		"logo": "icons/swackzards_logo.png",
        "title": "SWACKZARDS!",
		...
		"minidesc": "Styx & Crius turn boring activities into wacky hijinks for you to guffaw at.",
		"href": "/comics/swackzards/",
		"discontinued": false,
	},
    "comic3": {
        "thumb": "series/dh_comics_thumb.png",
		"logo": "icons/dh_logo.png",
		...
		"minidesc": "They call him DynamiteHead. He's the hottest bounty hunter superstar out there.",
		"href": "/comics/dynamitehead_comics/",
		"discontinued": true,
	},
    "comic4": {
        "thumb": "series/jimmy_comics_thumb.png",
		"logo": "icons/jimcomic_logo.png",
        "title": "Jimmy's Comical Journey",
		...
		"minidesc": "Jimmy and his friends save the day from Dr. Vegg in this wacky comic series.",
		"href": "/comics/jimmys_comical_journey/",
		"discontinued": true,
	},
    "comic5": {
        "thumb": "series/vegg_comics_thumb.png",
		"logo": "icons/vg_logo.png",
        "title": "Dr. Vegg 'n Nameless Comics",
		...
		"minidesc": "Dr. Vegg and Nameless are here to entertain you with their day to day shenanigans.",
